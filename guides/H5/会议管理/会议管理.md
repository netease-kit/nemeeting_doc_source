...
您可以调用 [`leaveCurrentMeeting`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEMeetingService.html#leaveCurrentMeeting) 离开当前进行中的会议，并通过参数控制（`leaveMeetingType`）是否同时结束当前会议。  
...
1. 调用 [`getSettingsService`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEMeetingKit.html#getSettingsService) 方法获取会议设置服务。
...
调用 [`getCurrentMeetingInfo`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEMeetingService.html#getCurrentMeetingInfo) 方法获取当前会议信息并进行回调处理。该接口的回调结果的数据类型为 [`NEMeetingInfo`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/types/NEMeetingInfo.html) 对象类型。
...
1. 注册回调接口 [`addListener`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEPreMeetingService.html#addListener) 开始监听，并在回调方法中根据您的需求处理相应事件。
...
2. 反注册回调接口 [`removeListener`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEPreMeetingService.html#removeListener) 停止监听。
...
1. 注册回调接口 [`addGlobalEventListener`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEMeetingKit.html#addGlobalEventListener) 开始监听，并在回调方法中根据您的需求处理相应事件。
...
2. 反注册回调接口 [`removeGlobalEventListener`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/interfaces/NEMeetingKit.html#removeGlobalEventListener) 停止监听。
