...
开始本文操作前，请确保您已经完成了 [登录鉴权](https://doc.yunxin.163.com/meeting/guide/DgxNTg1Njg?platform=h5)。

## 方案一：内置加密配置

NEMeetingKit 提供内置的媒体流加密功能，您可通过 [`NEMeetingParams.encryptionConfig`](https://doc.yunxin.163.com/meetingkit/references/web/typedoc/Latest/zh/h5/types/NEMeetingParams.html) 进行配置，目前支持国密 SM4-ECB 算法。
