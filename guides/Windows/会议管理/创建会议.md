...
1. 配置创建会议相关参数 [`NEStartMeetingParams`](https://doc.yunxin.163.com/docs/interface/meetingkit/windows/doxygen/Latest/zh/class_n_e_start_meeting_params.html) 和 [`NEStartMeetingOptions`](https://doc.yunxin.163.com/docs/interface/meetingkit/windows/doxygen/Latest/zh/class_n_e_start_meeting_options.html)。
...
2. 调用 [`startMeeting`](https://doc.yunxin.163.com/docs/interface/meetingkit/windows/doxygen/Latest/zh/class_n_e_meeting_service.html#a22683772dcd2adc46e35b4860e04ddbe) 方法创建会议并进行回调处理。该接口无额外回调结果数据，您可根据错误码判断接口是否调用成功。
...
调用 [`getCurrentMeetingInfo`](https://doc.yunxin.163.com/docs/interface/meetingkit/windows/doxygen/Latest/zh/class_n_e_meeting_service.html#ac18903de29f544e9755ab9eb5e8c9b1d) 方法获取当前会议信息并进行回调处理。该接口的回调结果的数据类型为 NEMeetingInfo 对象类型。
