...
调用 [`scheduleMeeting`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_pre_meeting_service.html#a593a92531678a568d90c1bbcaec85bc9) 方法预约会议并进行回调处理，您可根据错误码判断接口是否调用成功。
...
调用 [`editMeeting`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_pre_meeting_service.html#a883e08576bd77dbc79bd03a5e7b14bac) 方法编辑会议并进行回调处理，您可根据错误码判断接口是否调用成功。
...
调用 [`cancelMeeting`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_pre_meeting_service.html#a44b280334d96ae804cee85cdd910b729) 方法取消预约会议并进行回调处理，您可根据错误码判断接口是否调用成功。
...
调用 [`getMeetingItemByNum`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_pre_meeting_service.html#a21b2322d2edc0fbfe641dc308b1de2bc) 方法查询预约会议信息并进行回调处理，您可根据错误码判断接口是否调用成功。
...
调用 [`getMeetingList`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_pre_meeting_service.html#a1631e0a9ded246258ea16c1ff28bab89) 方法查询指定状态下的预约会议列表并进行回调处理，您可根据错误码判断接口是否调用成功。
...
1. 注册回调接口 [`addListener`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_account_service.html#adc5781e448f7bf19affc263c6438fd34) 开始监听，并在回调方法中根据您的需求处理相应事件。
...
2. 反注册回调接口 [`removeListener`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_account_service.html#a78e0df06c654b85ef514a4efd6a28d20) 停止监听。
