...
1. 配置加入会议相关参数 [`NEJoinMeetingParams`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_join_meeting_params.html) 和 [`NEJoinMeetingOptions`](https://doc.yunxin.163.com/docs/interface/meetingkit/linux/doxygen/Latest/zh/class_n_e_join_meeting_options.html)。
