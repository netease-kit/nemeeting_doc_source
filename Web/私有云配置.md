...
:::note note
该部署过程需要您与网易云信服务团队协作完成，因此若有私有云服务相关需求，请先前往 [网易云信官网](https://yunxin.163.com/) 联系商务经理一对一沟通您的需求。
:::
...
* AI howling 插件Simd地址
*/
    AIhowlingSimdUrl?: string;
/**
* AI howling 插件NoSimd地址
*/
    AIhowlingNoSimdUrl?: string;
},
