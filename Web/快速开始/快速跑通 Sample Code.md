本文主要介绍如何快速跑通网易会议组件的 [Web Sample Code](https://github.com/netease-kit/NEMeeting/tree/main/SampleCode/Web)，体验在线的多人视频会议功能。
...
1. 从 github 下载网易会议组件 Sample Code 源码，或者直接在命令行运行以下命令：
    ...
    ```
2. 通过 VSCode 打开 `NEMeeting/SampleCode/Web` 项目。

## 配置 Sample Code

1. 进入项目 `SampleCode/Web` 目录，运行以下命令进行依赖安装。
...
2. 服务启动后在浏览器窗口地址输入 `http://localhost:3001/index.html`，打开示例 App。

    效果图如下所示：

    依次单击 **初始化** > **登录** > **创建** 按钮即可进入会议主页。
    <img style="width:80%;border: 1px solid #BFBFBF;" src="https://yx-web-nosdn.netease.im/common/489344aaf58e1303c9a3f57d1b78022b/demo.jpg" alt="image" />