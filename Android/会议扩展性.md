...
- **会议透传字段**：[`NEStartMeetingParams.extraData`](https://doc.yunxin.163.com/meetingkit/references/android/dokka/Latest/zh/com/netease/yunxin/kit/meeting/sdk/NEStartMeetingParams.html#extraData)，用于传递会议级别的自定义数据。
- **成员透传字段**：[`NEMeetingParams.tag`](https://doc.yunxin.163.com/meetingkit/references/android/dokka/Latest/zh/com/netease/yunxin/kit/meeting/sdk/NEMeetingParams.html#tag)，用于传递参会者级别的自定义数据。
